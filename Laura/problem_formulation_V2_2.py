...
@author: ciullo
"""
#6 Insensitive uncertainties have been converted to constants
import numpy as np
...
def get_model_for_actor_problem_formulation(problem_formulation_id,outcome_type='time_series', direction_optimize =ScalarOutcome.MINIMIZE):
...
if __name__ == '__main__':
    get_model_for_actor_problem_formulation(3)